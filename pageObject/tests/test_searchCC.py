...
def main():
    try:
        ...
        add_ChronicCondition.do_addChronicCondition(add_chronic_condition_Data.chronicCondition)
        time.sleep(4)
        search_ChronicConditions = simple_search_chronic_conditions(driver)
        search_ChronicConditions.do_simple_search(simple_searchChronic_Data.search)
