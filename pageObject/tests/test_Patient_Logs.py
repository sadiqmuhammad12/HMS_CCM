...
from pageObject.pages.patient_Logs_Page import patient_Logs_page
from pageObject.config.patient_Log import log_data
...
def main():
    try:
        ...
        patient_Logs = patient_Logs_page(driver)
        patient_Logs.do_Patient_Logs(log_data.description)
        time.sleep(6)
